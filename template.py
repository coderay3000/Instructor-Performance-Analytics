...
list_of_files = [
    ...
    f"{project_name}/components/effectiveness_calculation.py",
    f"{project_name}/components/instructor_aggregation.py",
...
for filepath in list_of_files:
    ...
    if (not os.path.exists(filepath)) or (os.path.getsize(filepath)==0):
        ...
        print(f"{filepath} already exists and is not empty. Skipping file creation.")    
